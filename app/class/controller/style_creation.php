<?php
	...
	$json = array(
		...
		"url"=>$product->url,
		"price"=>$product->price,
		"above_close_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_close_front."'/>",
		"acf"=>$acf,
		"middle_close_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_close_front."'/>",
		"bottom_close_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_close_front."'/>",
		"above_close_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_close_back."'/>",
		"acb"=>$acb,
		"middle_close_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_close_back."'/>",
		"bottom_close_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_close_back."'/>",
		"above_open_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_open_front."'/>",
		"aof"=>$aof,
		"middle_open_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_open_front."'/>",
		"bottom_open_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_open_front."'/>",
		"above_open_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_open_back."'/>",
		"aob"=>$aob,
		"middle_open_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_open_back."'/>",
		"bottom_open_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_open_back."'/>",
		"above_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_front."'/>",
		"af"=>$af,
		"middle_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_front."'/>",
		"bottom_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_front."'/>",
		"above_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$above_back."'/>",
		"ab"=>$ab,
		"middle_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$middle_back."'/>",
		"bottom_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$bottom_back."'/>",
		"default_right_shoulder_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_right_shoulder_front."'/>",
		"drsf"=>$drsf,
		"default_left_shoulder_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_left_shoulder_front."'/>",
		"default_right_hand_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_right_hand_front."'/>",
		"drhf"=>$drhf,
		"default_left_hand_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_left_hand_front."'/>",
		"default_right_shoulder_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_right_shoulder_back."'/>",
		"drsb"=>$drsb,
		"default_left_shoulder_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_left_shoulder_back."'/>",
		"default_right_hand_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_right_hand_back."'/>",
		"drhb"=>$drhb,
		"default_left_hand_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_left_hand_back."'/>",
		"right_shoulder_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$right_shoulder_front."'/>",
		"rsf"=>$rsf,
		"left_shoulder_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_left_shoulder_back."'/>",
		"right_hand_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$right_hand_front."'/>",
		"left_hand_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$left_hand_front."'/>",
		"right_shoulder_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$right_shoulder_back."'/>",
		"rsb"=>$rsb,
		"left_shoulder_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$left_shoulder_back."'/>",
		"right_hand_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$right_hand_back."'/>",
		"rhb"=>$rhb,
		"left_hand_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$left_hand_back."'/>",
		"default_front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_front."'/>",
		"df"=>$df,
		"default_back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$default_back."'/>",
		"db"=>$db,
		"front"=>"<img src='".RESOURCE_PATH.DS."items".DS.$front."'/>",
		"f"=>$f,
		"back"=>"<img src='".RESOURCE_PATH.DS."items".DS.$back."'/>",
		"b"=>$b
	);
